...
<body>
    ...
    <h2>Connexion Administrateur</h2>
        ...
        <label for="login_ad">Login :</label>
        <input type="text" id="login_ad" name="login_ad" required>

        <label for="mdp_ad">Mot de passe :</label>
        <input type="password" id="mdp_ad" name="mdp_ad" required>
